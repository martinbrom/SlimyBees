...
public class SlimyBeesRegistry {
    ...
    private final Map<String, Map<ChromosomeType, Object>> specificChromosomeValues = new HashMap<>();
    ...
    public Map<String, Map<ChromosomeType, Object>> getSpecificChromosomeValues() {
        return specificChromosomeValues;
    }
